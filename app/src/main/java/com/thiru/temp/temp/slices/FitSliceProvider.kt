...
package com.thiru.temp.temp.slices

import android.net.Uri
import androidx.slice.Slice
import androidx.slice.SliceProvider
import com.thiru.temp.temp.DeepLink
...
class FitSliceProvider : SliceProvider() {
    ...
    companion object {
        ...
        internal const val SLICE_AUTHORITY = "com.example.temp.slices.provider"
    }
    ...
    private fun createNewSlice(sliceUri: Uri): FitSlice {
        ...
        return when (sliceUri.path) {
            ...
            DeepLink.STATS -> FitStatsSlice(
                context = context,
                sliceUri = sliceUri,
                fitRepo = FitRepository.getInstance(
                    context
                )
            )
